  ...
  <div style="min-height:100vh; background:var(--bg-base); display:flex; align-items:center; justify-content:center; padding:24px;">
    <div style="width:100%; max-width:400px;">
      ...
      <div class="card" style="padding:28px;">
        <h2 style="font-size:18px; font-weight:600; color:var(--txt-1); margin-bottom:6px;">Sign In</h2>
        <p style="font-size:13px; color:var(--txt-3); margin-bottom:24px;">Welcome back! Enter your credentials.</p>
        ...
        <div style="margin-top:20px; text-align:center; padding-top:20px; border-top:1px solid var(--border);">
          <p style="font-size:13px; color:var(--txt-3);">
            ...
            <RouterLink to="/register" style="color:var(--primary-txt); text-decoration:none; font-weight:500;">Sign Up</RouterLink>
          </p>
        </div>
